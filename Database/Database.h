...
namespace core
{
	namespace database
	{
		...
		public:
			...
			ECS_API void serialize(i_serializer* s, entity);
			ECS_API entity deserialize(i_serializer* s, i_patcher* patcher);
			...
			ECS_API void patch_chunk(chunk* c, i_patcher* patcher);
			//serialize
			ECS_API void serialize(i_serializer* s);
			ECS_API void deserialize(i_serializer* s);
			//clear
			ECS_API void clear();
